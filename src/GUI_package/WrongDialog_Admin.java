 ...
 * @author C L
 */
public class WrongDialog_Admin extends javax.swing.JFrame {

    /**
     * Creates new form AdminException
     */
    public WrongDialog_Admin() {
        initComponents();
    }

    WrongDialog_Admin(String message) {
        initComponents();
    ...
    private void initComponents() {
        ...
        msg_label.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        msg_label.setForeground(new java.awt.Color(255, 255, 255));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WrongDialog_Admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WrongDialog_Admin().setVisible(true);
            }
        });
    }
